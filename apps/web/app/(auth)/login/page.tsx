        ...
        <div className="dark min-h-screen flex bg-background-dark text-slate-100 font-heading antialiased">
            ...
            <div className="w-full lg:w-1/2 flex flex-col relative bg-background-dark">
                ...
                <div className="flex-1 flex items-center justify-center p-6 md:p-12 relative z-10">
                    <div className="w-full max-w-[440px] rounded-2xl p-8 md:p-10 relative overflow-hidden group"
                        style={{
                        ...
                        <div className="relative z-10">
                            ...
                            <form onSubmit={handleLogin} className="space-y-5">
                                ...
                                <div className="flex items-center justify-between pt-1">
                                    ...
                                    <button type="button" className="font-medium text-slate-400 hover:text-neon-cyan hover:underline transition-colors text-[14px]">Forgot Password?</button>
                                </div>

                                {/* Sign In Button */}
                                <div className="pt-4">
                                    <button
                                        className="w-full h-[48px] flex items-center justify-center rounded-xl shadow-[0_0_20px_rgba(0,245,255,0.3)] hover:shadow-[0_0_30px_rgba(0,245,255,0.5)] text-[16px] font-semibold text-white bg-gradient-to-r from-neon-cyan to-blue-500 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-neon-cyan/50 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:active:scale-100 group"
                                        type="submit"
                                        disabled={isLoading}
                                    >
                            ...
                            <div className="mt-8">
                                ...
                                <div className="mt-6">
                                    <button
                                        ...
                                        className="w-full h-[48px] flex justify-center items-center px-4 border border-white/10 rounded-xl bg-transparent text-[16px] font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-neon-cyan/50"
                                        type="button"
                                    >
                    ...
                    <div className="absolute bottom-8 text-center w-full z-10">
                        <p className="text-sm text-slate-500">
                            Don&apos;t have access?{' '}
                            <button type="button" className="font-medium text-slate-400 hover:text-white transition-colors underline-offset-2 hover:underline">
                                Contact Us
                            </button>
                        </p>
                    </div>
