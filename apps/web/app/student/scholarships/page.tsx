...
import { StudentScholarshipDashboard } from '@/components/student/student-scholarship-dashboard';
import {
    LuLayoutDashboard,
    LuCalendar,
    LuCheck,
                ...
                <div className="relative mb-8">
                    <div className="space-y-2">
                        <div className="flex items-center gap-3 text-emerald-400">
                            ...
                            <span className="text-xs font-black uppercase tracking-widest text-emerald-500">Academic Rewards</span>
                        </div>
                        <h1 className="text-5xl font-black text-white tracking-tighter">
                            Merit & <span className="text-emerald-400 italic">Support</span>
                        </h1>
                        <p className="text-text-secondary text-lg font-medium max-w-xl">
                            Track your academic rewards and financial support distributions, all secured and automated via smart contracts.
                        </p>
                    </div>
                </div>

                <StudentScholarshipDashboard />
            </div>
        </DashboardLayout>
    );
}
