...
export default function LegalPage() {
    return (
        <div className="min-h-screen bg-background text-text-primary font-sans relative">
            ...
            <nav className="sticky top-0 z-50 px-4 py-3 glass-morphism border-b border-border">
            ...
            <main className="max-w-4xl mx-auto px-6 py-20 relative z-10">
                ...
                <div className="grid sm:grid-cols-2 gap-8 mt-16">
                    ...
                    >
                        <Link href="/privacy-policy" className="block p-8 border border-border-hover rounded-3xl glass-morphism hover:border-primary/50 transition-all group">
                            ...
                            <p className="text-text-muted text-sm">Read exactly how we collect, store, and secure your institutional constraints and data schemas safely.</p>
                    ...
                    >
                        <Link href="/terms-of-service" className="block p-8 border border-border-hover rounded-3xl glass-morphism hover:border-secondary/50 transition-all group">
                            ...
                            <p className="text-text-muted text-sm">Review our general rules, disclaimers, and user conduct guidelines for interacting with our AI platform.</p>
