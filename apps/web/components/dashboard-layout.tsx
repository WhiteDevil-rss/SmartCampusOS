        ...
        <div className="h-screen flex overflow-hidden w-full overflow-x-hidden bg-background text-text-primary font-sans antialiased mesh-gradient max-w-[100vw] selection:bg-primary/30">
            ...
            <aside className="w-[280px] bg-surface border-r border-border hidden md:flex flex-col flex-shrink-0 z-20">
                ...
                <div className="p-6 border-t border-border bg-surface backdrop-blur-md relative overflow-hidden">
                    ...
                    <Button variant="ghost" className="w-full justify-start text-rose-500 hover:text-rose-600 hover:bg-rose-500/10 rounded-xl font-bold h-12 border border-transparent hover:border-rose-500/30 transition-all z-10 relative" onClick={() => handleLogout()}>
            ...
            <div className="flex-1 flex flex-col overflow-x-hidden relative">
                ...
                <header className="h-20 bg-background/80 backdrop-blur-xl border-b border-border flex items-center justify-between px-6 md:hidden flex-shrink-0 z-[var(--z-sticky)] sticky top-0 transition-all duration-500">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Button variant="ghost" size="icon" onClick={() => handleLogout()} className="rounded-xl bg-surface hover:bg-rose-500/10 transition-colors border border-border hover:border-rose-500/20">
                ...
                {/* Page Content */}
                <main className="flex-1 p-6 md:p-10 relative w-full main-content">
